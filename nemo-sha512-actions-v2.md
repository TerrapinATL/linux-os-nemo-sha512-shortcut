...
* Sections 08-09: Confirm the `Exec=` line matches:
  `Exec=/home/<YOURUSERNAME>/.local/bin/verify-album-sha512 %F`

* Sections 18-19: Confirm the `Exec=` line matches:
  `Exec=/home/<YOURUSERNAME>/.local/bin/verify-artist-sha512 %F`
...
Use after a Linux reinstall, system rebuild, or move to another machine.
    ...
    1. Copy: verify-album-sha512 and verify-artist-sha512 to ~/.local/bin/
...
--- Bash Script End ---
    ...
    5. Test both actions as described in Section 22 — Part 6: Testing.
